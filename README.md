...
| `digital-archive-member-genspark` | https://digital-archive-member-genspark.vercel.app/ | `vercel.member-genspark.json` → 성도용 챗봇(젠스파크).html |
| `digital-archive-member-chat` | https://digital-archive-member-chat.vercel.app/ | `vercel.member-chat.json` → chat for member.html |
